import sys, socket, agent, address, threading, os
...
class Window(QWidget):
	def __init__(self, parent=None):
		...
		self.setWindowTitle("PARTY AGENT")
		self.resize(400, 300)
	...
	def socketCreation(self):
		...
		try:
			self.conn = agent.Node(s, address.Address(self.ip, self.port), address.Address(host_ip, int(host_port)))
